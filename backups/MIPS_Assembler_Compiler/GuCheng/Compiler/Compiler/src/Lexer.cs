        ...
        class Lexer
        {
            ...
            private double readHex()
            {
                ...
                while (Char.IsDigit(_current) || 
                    ( Char.IsLetter(_current) && Char.ToLower(_current) >= 'a' && Char.ToLower(_current) <= 'f')
                    )
                {
                    r *= 16;
                    if (Char.IsDigit(_current))
                        ...
                        r = r + ( Char.ToLower(_current) - 'a') + 10;
                    _current = _source.next();
                }
                return r;
            }
                    ...
                    switch (_current)
                    {
                        ...
                        default:
                            ...
                            if (Char.IsLetter(_current) || _current == '_')
                            {
                                ...
                                else if (_currentStringToken == "in")
                                    _currentToken.TokenType = TokenType.TOKEN_IN;
                                else if (_currentStringToken == "out")
                                    _currentToken.TokenType = TokenType.TOKEN_OUT;
                                else
                                {
